                                    ...
                                    <li class="front-seat">
                                        <ul>
                                            <li class="single-seat">
                                                <img
                                                    src="assets/img/movie/seat-1.png"
                                                    alt="seat">
                                            </li>
                                            <li class="single-seat">
                                                <img
                                    ...
                                    <li class="front-seat">
                                        <ul>
                                            <li class="single-seat seat-free">
                                                <img
                                                    src="assets/img/movie/seat-1-free.png"
                                                    alt="seat">
                                                <span class="sit-num">h5</span>
                                            </li>
                                            <li class="single-seat seat-free">
                                                <img
                                                    src="assets/img/movie/seat-1-booked.png"
                                                    alt="seat">
                            ...
                            <li class="seat-line">
                                ...
                                <ul class="seat--area">
                                    <li class="front-seat">
                                        <ul>
                                            <li
                                                class="single-seat seat-free-two">
                                                <img
                                                    src="assets/img/movie/seat-2-free.png"
                                                    alt="seat">
                                                <span class="sit-num">e1
                                                    e2</span>
                                            </li>
                                            <li
                                                class="single-seat seat-free-two">
                                    ...
                                    <li class="front-seat">
                                        <ul>
                                            <li class="single-seat">
                                                <img
                                                    src="assets/img/movie/seat-2.png"
                                                    alt="seat">
                                            </li>
                                            <li class="single-seat">
                                                <img
                                    ...
                                    <li class="front-seat">
                                        <ul>
                                            ...
                                            <li
                                                class="single-seat seat-free-two">
                                                <img
                                                    src="assets/img/movie/seat-2-booked.png"
                                                    alt="seat">
                                                <span
                                                    class="sit-num booked-bg">D7
                                                    D8</span>
                                            </li>
                                            <li class="single-seat">
                                                <img
                                        ...
                                        <ul>
                                            <li
                                                ...
                                                <img
                                                    ...
                                                    alt="seat">
                                                <span
                                                    class="sit-num booked-bg">a11</span>
                                            </li>
                                            <li
                                                class="single-seat seat-free-two">
                                                <img
                    ...
                    <div class="proceed-to-book">
                        ...
                        <div class="book-item">
                            <a href="movie-checkout.html"
                                class="custom-button">checkout now</a>
                        </div>
                    </div>
                </div>
            </div>
